#ifndef SL_EMLIB_GPIO_INIT_EEPROM_ENABLE_CONFIG_H
#define SL_EMLIB_GPIO_INIT_EEPROM_ENABLE_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_EEPROM_ENABLE_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_EEPROM_ENABLE_MODE        gpioModeWiredAnd

// <o SL_EMLIB_GPIO_INIT_EEPROM_ENABLE_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_EEPROM_ENABLE_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_EEPROM_ENABLE
// $[GPIO_SL_EMLIB_GPIO_INIT_EEPROM_ENABLE]
// [GPIO_SL_EMLIB_GPIO_INIT_EEPROM_ENABLE]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_EEPROM_ENABLE_CONFIG_H
